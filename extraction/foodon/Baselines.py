...
parser.add_argument("--transe_embedding_file", type=str, default='openke_foodon/transe_embedding.vec.json')
parser.add_argument("--transr_embedding_file", type=str, default='openke_foodon/transr_embedding.vec.json')
parser.add_argument("--distmult_embedding_file", type=str, default='openke_foodon/distmult_embedding.vec.json')
parser.add_argument("--openke_entity_file", type=str, default='openke_foodon/entity2id.txt')
...
class InclusionEvaluator(Evaluator):
    ...
    def evaluate(self, model, eva_samples):
        ...
        for sample in eva_samples:
            ...
            if rank_non > rank:
                csv_file_path = f'foodon_{FLAGS.embedding_type}.csv'
